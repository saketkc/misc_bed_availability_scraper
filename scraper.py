  ...
  for city in ['up']:
    ...
    # ~ try:
      if city=='bengaluru':
        ...
        pbar=tqdm.tqdm(districts,description='parsing for UP district: '+districts[0])
        for district in pbar:
          pbar.set_description(pbar='parsing for UP district: '+district)
